...
export const garageOutput = document.getElementById(`garageOutput`);
//Delete Garage (DELETE)
export const delGarageID = document.getElementById(`delGarageID`);
export const deleteGarageButton = document.getElementById(`deleteGarageButton`);
//Update Garage (PUT)
export const updateGarageID = document.getElementById(`updateGarageID`);
export const updateName = document.getElementById(`updateName`);
export const updateGarageButton = document.getElementById(`updateGarageButton`);
